...
class assigndriverClass:
    ...
    def ViewTable(self):
        ...
        #================BookedTitel====================================
        Bookedtitle=Label(frmBooked, text="Unconfirmed Trip List", font=("goudy old style",15,"bold"),bg="#ffc107", fg="white").pack(side=TOP,fill=X)
        #=================Scrollbar=============================
        ...
        #================ConformedTitel====================================
        Conformedtitle=Label(frmConform, text="Confirmed Trip List", font=("goudy old style",15,"bold"),bg="#2E4CC5", fg="white").pack(side=TOP,fill=X)
        #=================Scrollbar=============================
    ...
    def AssignDriver(self):
        ...
        try:
            if self.var_driver.get() == "" or self.var_customer.get() == "":
                ...
                result=databaseConnection.cur.execute("Update booking set status='Confirmed', reg_id=? where c_id=? and cancel='No'", (
