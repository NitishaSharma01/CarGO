...
class driverDetailsClass:
    def __init__(self, root):
        ...
        self.root.title("Driver Details || CarGO")
        ...
        try:
            if self.var_reg_id.get() == "":
                ...
                if row == None:
                    ...
                    databaseConnection.con.commit()
                    messagebox.showinfo(
                        "Sucess", "Driver's Details Updated Sucessfully", parent=self.root)
                    self.clear()
                    self.show()
        except Exception as ex:
            messagebox.showerror(
            ...
            if self.var_reg_id.get() == "":
                ...
                if row == None:
                    ...
                    if op == True:
                        ...
                        databaseConnection.con.commit()
                        messagebox.showinfo(
                            "Delete", "Driver Deleted Successfully", parent=self.root)
                        self.clear()
                        self.show()
    ...
    def search(self):
        ...
        try:
            if self.var_searchby.get() == "Select":
                ...
                messagebox.showerror(
                    "Error", "Search input must be required.", parent=self.root)
            else:
