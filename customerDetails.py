...
class customerDetailsClass:
    def __init__(self, root):
        ...
        self.root.title("Customer Details || CarGO!!")
    ...
    #================Content=======================================
        ...
        txt_gender=ttk.Combobox(self.root,textvariable=self.var_gender, values=("Select","Male","Female","Transgender"),state='readonly',justify=CENTER,font=("goudy old style",10))
    ...
    def add(self):
        ...
        try:
            if self.var_name.get() == "" or self.var_email.get()=="" or self.var_password.get()=="":
                ...
                if row != None:
                    messagebox.showerror(
                        "Error", "This email-id already exits, Try another", parent=self.root)
                else:
        ...
        try:
            if self.var_c_id.get() == "":
                ...
                if row == None:
                    ...
                    databaseConnection.con.commit()
                    messagebox.showinfo(
                        "Sucess", "Customer's Details Updated Sucessfully", parent=self.root)
            ...
            if self.var_c_id.get() == "":
                ...
                if row == None:
                    ...
                    if op == True:
                        ...
                        databaseConnection.con.commit()
                        messagebox.showinfo(
                            "Delete", "Customer Deleted Successfully", parent=self.root)
                        self.clear()
                        self.show()
