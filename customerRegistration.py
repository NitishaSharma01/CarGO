...
class customerRegClass:
    def __init__(self, root):
        ...
        self.root.title("Customer Registration || CarGO!!")
    ...
    #================Content=======================================
        ...
        #================Labels-Row-3====================================
        lbl_card=Label(frm, text="Card Details", font=("goudy old style",15),bg="white").place(x=32,y=230)
        lbl_gender=Label(frm, text="Gender", font=("goudy old style",15),bg="white").place(x=390,y=230)
        #===============ComboBoxForGender-Row-3==============================
        txt_gender=ttk.Combobox(frm,textvariable=self.var_gender, values=("Select","Male","Female","Transgender"),state='readonly',justify=CENTER,font=("goudy old style",10))
