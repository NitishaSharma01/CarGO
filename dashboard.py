...
class DashboardClass:
    def __init__(self, root, email):
        ...
        self.root.title("Dashboard || CarGO!!")
        ...
        #============Clock===============
        self.lbl_clock = Label(self.root, text="Welcome to CarGO!!\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS\t\t Welcome: "+email,font=("time new roman", 15),bg="#4d636d",fg="white")
        self.lbl_clock.place(x=0,y=70, relwidth=1, height=30)

        #=============Left_Menu===========
        self.MenuLogo=Image.open("images/taxibookingsystm.png")
        self.MenuLogo=self.MenuLogo.resize((160,160), Image.ANTIALIAS)
        ...
        #============lbl_Menu==================
        lbl_menu=Label(LeftMenu, text="Menu", font=("time new roman",23,"bold"), bg="#009688").pack(side=TOP,fill=X)
        ...
        btn_driver=Button(LeftMenu, text=" Cab Driver", command=self.driverdetails, image=self.imgsupplier, compound=LEFT, padx=5, anchor="w", font=("time new roman",20, "bold"), bg="white", bd=3, cursor="hand2").pack(side=TOP,fill=X)
        ...
        #============Content===================
        self.lbl_customer=Label(self.root, text="Total Customer\n[ 0 ]",bd=4,relief=RIDGE, bg="#33bbf9", fg="white", font=("goudy old sytyle", 18, "bold"))
        self.lbl_customer.place(x=320, y=120,height=140,width=220)

        self.lbl_employee=Label(self.root, text="Total Employee\n[ 0 ]",bd=4,relief=RIDGE, bg="#009688", fg="white", font=("goudy old sytyle", 18, "bold"))
        self.lbl_employee.place(x=560, y=120,height=140,width=220)

        self.lbl_driver=Label(self.root, text="Total Cab Driver\n[ 0 ]",bd=4,relief=RIDGE, bg="#607d8b", fg="white", font=("goudy old sytyle", 18, "bold"))
        self.lbl_driver.place(x=800, y=120,height=140,width=220)

        self.lbl_AvDriver=Label(self.root, text="Total Available \nDriver\n[ 0 ]",bd=4,relief=RIDGE, bg="#7F7F7F", fg="white", font=("goudy old sytyle", 18, "bold"))
        self.lbl_AvDriver.place(x=1030, y=120,height=140,width=220)

        self.lbl_UnAvDriver=Label(self.root, text="Total Unavailable \nDriver\n[ 0 ]",bd=4,relief=RIDGE, bg="#C42F11", fg="white", font=("goudy old sytyle", 18, "bold"))
        self.lbl_UnAvDriver.place(x=320, y=300,height=140,width=220)

        self.lbl_total_trip=Label(self.root, text="Total Booked \nTrip\n[ 0 ]",bd=4,relief=RIDGE, bg="#ffc107", fg="white", font=("goudy old sytyle", 18, "bold"))
        self.lbl_total_trip.place(x=560, y=300,height=140,width=220)

        self.lbl_conf_trip=Label(self.root, text="Total Confirmed \nTrip\n[ 0 ]",bd=4,relief=RIDGE, bg="#2E4CC5", fg="white", font=("goudy old sytyle", 18, "bold"))
        self.lbl_conf_trip.place(x=800, y=300,height=140,width=220)

        self.lbl_Unconf_trip=Label(self.root, text="Total \nUnconfirmed Trip\n[ 0 ]",bd=4,relief=RIDGE, bg="#410F05", fg="white", font=("goudy old sytyle", 18, "bold"))
        self.lbl_Unconf_trip.place(x=1030, y=300,height=140,width=220)

        self.lbl_can_trip=Label(self.root, text="Total Cancelled \n Trip\n[ 0 ]",bd=4,relief=RIDGE, bg="#ff5722", fg="white", font=("goudy old sytyle", 18, "bold"))
        self.lbl_can_trip.place(x=320, y=480,height=140,width=220)

        self.lbl_closeBook=Label(self.root, text="Total Completed Trip\n[ 0 ]",bd=4,relief=RIDGE, bg="#865A68", fg="white", font=("goudy old sytyle", 18, "bold"))
        self.lbl_closeBook.place(x=560, y=480,height=140,width=220)

        self.lbl_income=Label(self.root, text="Total Fare\n[ 0 ]",bd=4,relief=RIDGE, bg="#1CA345", fg="white", font=("goudy old sytyle", 18, "bold"))
        self.lbl_income.place(x=800, y=480,height=140,width=220)
...
#===================================================================================================
    ...
    def update_date_time(self):
        ...
        self.lbl_clock.config(text=f"Welcome!!\t\t Date:{str(date_)} \t\t Time:{str(time_)} \t\t Welcome: "+self.email )
    ...
    def LogOutFunc(self):
        ...
        self.new_obj=CBS(self.withdraw) 
        self.root.destroy()
    ...
    def updateContent(self):
        ...
        try:
            ...
            self.lbl_driver.config(text=f"Total Cab \nDriver\n[ {str(len(driver))} ]")
            ...
            self.lbl_income.config(text=f"Total Cost \n [{(Rev)}] ")
